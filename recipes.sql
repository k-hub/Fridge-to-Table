...
SELECT pg_catalog.setval('ingredients_ingredient_id_seq', 1398, true);
...
SELECT pg_catalog.setval('recipe_diets_recipe_diet_id_seq', 1361, true);
...
573	556315	36	2.0 tablespoons
574	556315	247	1.0 serving
575	556315	248	8.0 slices
576	556315	42	0.75 cup
577	556315	17	1.0 cup
578	556315	249	1.0 
579	32104	1	40.0 g
...
657	164135	274	8.0 oz
658	164135	275	1.5 cups
659	164135	276	15.0 oz
660	164135	58	1.0 tablespoon
661	164135	277	2.0 tablespoons
662	164135	17	1.5 cups
663	164135	101	14.5 oz
...
SELECT pg_catalog.setval('recipe_ingredients_recipe_ingredient_id_seq', 6769, true);
